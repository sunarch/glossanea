...
class ConvertDataV1ToV2:
    ...
    def run(cls, arguments):
        ...
        if len(arguments) != 1:
            print('One argument required: data file name or "all".')
            return
    ...
    @classmethod
    def convert_one(cls, arg_data_file_path):
    ...
    @classmethod
    def _fill_template_v2_with_data_v1(cls, arg_data):
    ...
    @classmethod
    def _build_format_content_list(cls, arg_data, arg_template):
